...
const NavList: React.FC<NavListProps> = ({ onLogout }) =>
    ...
    <Menu>
      ...
      <MenuList>
        ...
        <MenuItem className="flex items-center gap-2 ">
          ...
          <Typography variant="small" className="font-medium" onClick={onLogout}>
            Logout
          </Typography>
        </MenuItem>
      </MenuList>
    ...
    <MatNavbar className="mx-auto w-screen" fullWidth>
      <div className="flex items-center justify-between text-blue-gray-900">
        <Typography
          ...
          href="#"
          variant="h6"
          className="flex flex-row r-4 cursor-pointer py-1.5 gap-1"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
